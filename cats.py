...
class Cat:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.gender = gender
        self.status = status
        self.former_nobility = former_nobility
        ...
        if self.nobility_rank is None:
            self.nobility_rank = 1
        
        # if self.nobility_rank == 1:
        #    self.nobility == "commoner"
        # elif self.nobility_rank == 2:
        #    self.nobility == "knight"
        # elif self.nobility_rank == 3:
        #    self.nobility == "baron"
        # elif self.nobility_rank == 4:
        #    self.nobility == "viscount"
        # elif self.nobility_rank == 5:
        #    self.nobility == "earl"
        # elif self.nobility_rank == 6:
        #    self.nobility == "marquess"
        # elif self.nobility_rank == 7:
        #    self.nobility == "duke"

        # former nobility
        if self.former_nobility is None:
            self.former_nobility = "1"
        else:
            self.former_nobility = self.former_nobility
...
# pylint: disable=f-string-without-interpolation
    ...
    def unset_mate(self, other_cat: Cat, breakup: bool = False, fight: bool = False):
        ...
        if self.former_nobility >= other_cat.former_nobility:
            self.nobility_rank = self.former_nobility
        else:
            other_cat.nobility_rank = other_cat.former_nobility
    ...
    def set_mate(self, other_cat: Cat):
        ...
        if self.nobility_rank >= other_cat.nobility_rank and not self.nobility_rank == 2:
            other_cat.nobility_rank = self.nobility_rank
        elif other_cat.nobility_rank > self.nobility_rank and not other_cat.nobility_rank == 2:
            self.nobility_rank = other_cat.nobility_rank
    ...
    def set_adoptive_parent(self, other_cat: Cat):
        ...
        if not other_cat.dead:
            ...
            other_relationship.comfortable += 20
            other_relationship.trust += 10
        if self.nobility_rank <= other_cat.nobility_rank and not other_cat.nobility_rank == 2:
            self.nobility_rank = other_cat.nobility_rank
    ...
    def get_save_dict(self, faded=False):
        if faded:
            ...
            return {
                ...
                "status": self.status,
                "former_nobility": self.former_nobility,
                "nobility_rank": self.nobility_rank,
