...
from .ChooseNobilityScreen import ChooseNobilityScreen
...
class AllScreens:
    ...
    # Kingdom screens
    choose_nobility_screen = ChooseNobilityScreen("choose nobility screen")
    ...
    def rebuild_all_screens(cls):
        ...
        # Kingdom screens
        cls.choose_nobility_screen = ChooseNobilityScreen("choose nobility screen")
