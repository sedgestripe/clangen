...
class ChooseAdoptiveParentScreen(Screens):
    ...
    def update_selected_cat(self):
        ...
        self.selected_cat.nobility_str = "commoner"
        if self.selected_cat.nobility_rank == 2:
            self.selected_cat.nobility_str = "knight"
        elif self.selected_cat.nobility_rank == 3:
            self.selected_cat.nobility_str = "baron"
        elif self.selected_cat.nobility_rank == 4:
            self.selected_cat.nobility_str = "viscount"
        elif self.selected_cat.nobility_rank == 5:
            self.selected_cat.nobility_str = "earl"
        elif self.selected_cat.nobility_rank == 6:
            self.selected_cat.nobility_str = "marquess"
        elif self.selected_cat.nobility_rank == 7:
            self.selected_cat.nobility_str = "duke"
        ...
        info = (
            ...
            + "\n"
            + self.selected_cat.nobility_str
            + "\n"
